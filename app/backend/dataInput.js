...
const requiredCourses = ['CSC108', 'CSC148', 'CSC165', 'MAT137', 'MAT157', 'MAT135', 'MAT136']
const req = 'https://cobalt.qas.im/api/1.0/courses/filter?key=RyvDnYdKxsblregFbObVQPtVdlN2CpQW&limit=100&q=code%3A%22CSC%22%20AND%20department%3A%22computer%20science%22%20AND%20term%3A%222018%20Fall%22%20OR%20term%3A%222019%20Winter%22%20'
...
export function fetchAllCourses() {
  ...
  let filteredCourses = filterCourses('UTSG', 1, 2019, "Computer Science", ['Mathematical and Computational Sciences', 'Dept. of Computer & Mathematical Sci (UTSC)']);

  // 0 = all, 1 = early, 2 = late.
  buildTimeTable(filteredCourses, 0);
}

function filterCourses(selectedCampus, yearOfStudy, schoolYear, selectedDepartment, interests) {
  // console.log(example[0]);
  let filteredCourses = new PriorityQueue();
